...
public class MaterialsList {
    ...
    private int[] framesList = {R.drawable.frame_white, R.drawable.frame_black ,
            ...
            R.drawable.frame_vividyellow, R.drawable.frame_doraemon, R.drawable.frame_lime,
            R.drawable.frame_mix_papermint, R.drawable.frame_mix_purple, R.drawable.frame_mix_red,
            R.drawable.frame_mix_yellow, R.drawable.frame_mix_wheat, R.drawable.frame_mix_toy,
            R.drawable.frame_drop, R.drawable.frame_star, R.drawable.frame_dounut};
